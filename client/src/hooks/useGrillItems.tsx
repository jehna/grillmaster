...
const GrillItemsContext = createContext<GrillItemsContextType | undefined>(
  undefined
);
...
export function GrillItemsProvider({ children }: { children: ReactNode }) {
  ...
  const toggleItemSelection = useCallback(
    (item: GrillItemType, selected: boolean) => {
